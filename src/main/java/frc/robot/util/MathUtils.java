...
public class MathUtils {
    ...
    public static double convertTicksToMeters(double ticks, double ticksPerRotation, double gearRatio,
        ...
        double meters = wheelRotations * MathUtils.inchesToMeters(wheelCircumference);
        return meters;
    }
    ...
    public static double RPMtoMetersPerSecond(double ticksPer100ms, double ticksPerRotation, double gearRatio,
        ...
        double metersPerSecond = wheelRotationsPerSecond * MathUtils.inchesToMeters(wheelCircumference);
